...
[4] Excluir conta desativada {'- INDISPONÍVEL' if not ha_contas_desativadas else ''}
[5] Alterar valor limite de saque
[6] Alterar limite de saques diários
[0] Sair
'''
